...
def r2_mock(mocker):
    ...
    Supports r2.get(key) and r2.put(key, data); returns (r2_instance,
    storage_dict) so tests can inspect what got persisted.
    """
    storage = {}
...
def test_load_tolerates_missing_optional_keys(r2_mock):
    ...
    storage["king/current.json"] = {"hotkey": "x", "hf_repo": "r/m"}
